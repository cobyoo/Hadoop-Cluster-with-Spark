...
#export HADOOP_OPTS="$HADOOP_OPTS -xx:-PrintWarnings -Djava.net.preferIOPv4Stack=true -Djava.library.path=/home/dblab/hadoop/lib/native"
#export HADOOP_OPTS="$HADOOP_OPTS -Djava.library.path=/home/dblab/hadoop/lib/native"
#export HADOOP_COMMON_LIB_NATIVE_DIR="/home/dblab/hadoop/lib/native/"
